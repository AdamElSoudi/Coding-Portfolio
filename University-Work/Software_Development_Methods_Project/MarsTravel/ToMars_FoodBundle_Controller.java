...
/**
 * Scene for choosing food bundle on journey to Mars
 */
public class ToMars_FoodBundle_Controller {

    @FXML
    private Button btnCancel;

    @FXML
    private AnchorPane btnCabinInfo;

    @FXML
    private Button btnMealsInfoTo;

    @FXML
    private Button btnSave;

    @FXML
    private Label lblMealsToMars;
     ...
     */
    private void setMealsToMars() {
        if (Order.getFoodBundleChoiceTo() == 0) {
        ...
        } else if (Order.getFoodBundleChoiceTo() == 1) {
            opt1.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 2) {
            opt2.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 3) {
            opt3.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 4) {
            opt4.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 5) {
            opt5.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 6) {
            opt6.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 7) {
            opt7.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 8) {
            opt9.setSelected(true);
        } else if (Order.getFoodBundleChoiceTo() == 9) {
            opt9.setSelected(true);
        }
    }
     ...
     */
    @FXML
    void checkboxSelectedFoodBundleToMars(ActionEvent event) throws IOException {
    ...
    public void openFoodBundleInfoScene(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("ToMars_Info_FoodBundle.fxml"));
    ...
    /**
     * Opens previous scene in booking process, ToMars_Cabin
     * @param event user pressed button for going backwards in booking process
     * @throws IOException
     */
    @FXML
    public void openCabinToMarsScene(ActionEvent event) throws IOException {
        checkCheckBoxSelected();
     ...
     */
    @FXML
    public void openEventTicketsToMarsScene(ActionEvent event) throws IOException {
        checkCheckBoxSelected();

        if (!(Order.getFoodBundleChoiceTo() == 0)) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ToMars_EventTickets.fxml"));
            Parent parent = loader.load();
            Scene eventTicketsToMarsScene = new Scene(parent);
            Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
            window.setScene(eventTicketsToMarsScene);
            window.show();
        } else { //Error message if no choice made
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ToMars_FoodBundle_NoChoiceMade.fxml"));
            Parent parent = loader.load();
