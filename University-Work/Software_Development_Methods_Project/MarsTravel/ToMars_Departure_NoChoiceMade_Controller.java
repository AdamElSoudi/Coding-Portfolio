...
//TODO Class not currently in use

/**
 * Error message scene
 * Opens if no choice is made in scene for food bundles on journey to Mars
 */
public class ToMars_Departure_NoChoiceMade_Controller {
    ...
    @FXML
    private Label lblNoChoiceMadeDepartureMars;

    /**
     * Opens scene for choosing departure date to Mars
     * @param event user pressed button for going back to date for departure to Mars
     * @throws IOException
     */
    @FXML
    void openToMarsDepartureScene(ActionEvent event) throws IOException {
