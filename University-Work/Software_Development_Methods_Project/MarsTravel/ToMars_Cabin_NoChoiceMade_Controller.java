...
/**
 * Error message scene
 * Opens if no choice is made in scene for booking cabin on journey to Mars
 */
public class ToMars_Cabin_NoChoiceMade_Controller {
    ...
    /**
     * Opens scene for booking cabin on journey to Mars
     * @param event user pressed button for going back to scene for booking cabin to Mars
     * @throws IOException
     */
    @FXML
    void openCabinToMarsScene(ActionEvent event) throws IOException {
