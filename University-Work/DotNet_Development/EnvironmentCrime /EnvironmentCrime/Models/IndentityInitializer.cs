...
{
	public class IndentityInitializer
	{
        public static async Task EnsurePopulated(IServiceProvider services)
        {
            ...
            await CreateNewUser(userManager);
        }
        ...
        //Creating usernames for employees to log in with.
        private static async Task CreateNewUser(UserManager <IdentityUser> uManager)
        {
            ...
            //Creating passwords for employees to log in with.
            ...
            //Specifying the roles of each employee.
