...
/**
 *Scene for booking of cabin from Mars
 */
public class FromMars_Cabin_Controller {
    ...
    @FXML
    private Label lblCabinFromMars;
    ...
    private void setStartCheckbox() {
        if (Order.getCabinChoiceFrom() == 0) {
            opt1.setSelected(false);
            opt2.setSelected(false);
            opt3.setSelected(false);
            opt4.setSelected(false);
        } else if (Order.getCabinChoiceFrom() == 2) {
            opt1.setSelected(true);
        } else if (Order.getCabinChoiceFrom() == 3) {
            opt2.setSelected(true);
        } else if (Order.getCabinChoiceFrom() == 4) {
            opt3.setSelected(true);
        } else if (Order.getCabinChoiceFrom() == 5) {
            opt4.setSelected(true);
        } else if (Order.getCabinChoiceFrom() == 1) {
    ...
    private void checkCheckBoxSelected() {
        if (!(opt1.isSelected() || opt2.isSelected() || opt3.isSelected() || opt4.isSelected() || opt5.isSelected())) {
            Order.setCabinChoiceFrom(0);
        }
    }

    /**
     * Opens scene for cabin info from Mars
    ...
    public void openCabinInfoScene(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FromMars_Info_Cabin.fxml"));
     ...
     */
    @FXML
    public void openFoodBundleFromMars(ActionEvent event) throws IOException {
        checkCheckBoxSelected();
        ...
        if(opt1.isSelected() || opt2.isSelected() || opt3.isSelected() || opt4.isSelected()) {
            ...
            Parent parent = loader.load();
            Scene foodBundleFromMarsScene = new Scene(parent);
            Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
            window.setScene(foodBundleFromMarsScene);
            window.show();

        }
        //Correct case if choice is option 5 which means no need of food bundle or event tickets
        else if (opt5.isSelected()) {
            Order.setFoodBundleChoiceFrom(10);
        ...
        //Error message if no choice made
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("FromMars_Cabin_NoChoiceMade.fxml"));
            Parent parent = loader.load();
    ...
    /**
     * Returns to previous view. Opens hotel on Mars selection view.
     * @param event user pressed button to go back.
     * @throws IOException
     */
    @FXML
    void openHotelOnMars(ActionEvent event) throws IOException {
        checkCheckBoxSelected();
