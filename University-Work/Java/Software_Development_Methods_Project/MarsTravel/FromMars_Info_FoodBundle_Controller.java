...
/**
 * Scene for information about food bundles from Mars
 */
public class FromMars_Info_FoodBundle_Controller {

    @FXML
    private Button btnCancel;

    /**
     * Builds a string with information from database about food bundle option from Mars
     ...
     * @param event user pressed button for going back to scene for choosing food bundle on journey from Mars
     * @throws IOException
     */
    @FXML
